...
<body class="hold-transition layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    <!--begin::App Wrapper-->
    <div class="app-wrapper">
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">@yield('title', 'Aplikasi Penjualan')</h3>
                        </div>
                    </div>
                    <!--end::Row-->
                </div>
        ...
        <footer class="app-footer">
            ...
            <strong>
                Copyright &copy; 2025&nbsp;
                <a href="#" class="text-decoration-none">Penjualan</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer>
